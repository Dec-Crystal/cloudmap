...
function getRangeLegend(colorArr, valueRangeArr) {
    var map_scaleHtml = '<img src="./Chinese_Stock_Treemap_files/you.png" alt="" id="legend-close" class="legend-switch"><img src="./Chinese_Stock_Treemap_files/zuo.png" alt="" id="legend-open" class="legend-switch">';
